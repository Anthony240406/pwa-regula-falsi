...
def regula_falsi_modificada(N, error_exp, max_iter=100):
    ...
    # 1) Intervalo inicial basado en floor/ceil(√N) o [0,max(1,N)]
    ...
    # Inicializar x_n para eliminar warning de “referenced before assignment”
    x_n = x_prev
    ...
    # No convergió antes de max_iter
    return x_n, tabla
